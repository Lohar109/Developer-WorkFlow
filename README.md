...
Fonts: Space Grotesk & Roboto Mono (via Google Fonts)
...
Bash
git clone https://github.com/your-username/devfocus-dashboard.git
Open the project:
Simply double-click index.html in your browser, or use a "Live Server" extension in VS Code.

📂 Project Structure
Plaintext
├── index.html          # Main Dashboard
├── analytics.html      # Productivity Analytics Page
├── settings.html       # Theme & Data Settings
├── profile.html        # User Profile Page
├── script.js           # Core Dashboard Logic
├── analytics.js        # Charting & Stats Logic
├── settings.js         # Theme & Export Logic
├── profile.js          # Profile & Socials Logic
